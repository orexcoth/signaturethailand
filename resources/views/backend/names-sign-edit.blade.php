...
@section('subcontent')
    ...
    <form method="post" action="{{route('BN_names_sign_edit_action')}}" enctype="multipart/form-data">
        @csrf
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 lg:col-span-12">
                <div class="intro-y box p-5">
                    <input type="hidden" name="signs_id" value="{{$sign->id}}" />
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            ...
                            <div class="col-span-12 xl:col-span-12">
                                <div class="mt-3">
                                    ...
                                    <input type="range" id="work" name="work" min="0" max="5" class="w-full" value="{{$sign->work}}" required>
                            ...
                            <div class="col-span-12 xl:col-span-12">
                                <div class="mt-3">
                                    ...
                                    <input type="range" id="finance" name="finance" min="0" max="5" class="w-full" value="{{$sign->finance}}" required>
                            ...
                            <div class="col-span-12 xl:col-span-12">
                                <div class="mt-3">
                                    ...
                                    <input type="range" id="love" name="love" min="0" max="5" class="w-full" value="{{$sign->love}}" required>
                            ...
                            <div class="col-span-12 xl:col-span-12">
                                <div class="mt-3">
                                    ...
                                    <input type="range" id="health" name="health" min="0" max="5" class="w-full" value="{{$sign->health}}" required>
                            ...
                            <div class="col-span-12 xl:col-span-12">
                                <div class="mt-3">
                                    ...
                                    <input type="range" id="fortune" name="fortune" min="0" max="5" class="w-full" value="{{$sign->fortune}}" required>
                            ...
                            <div class="col-span-12">
                                <div class="mt-3">
                                    ...
                                    <textarea class="form-control w-full" id="description" name="description" class="form-control w-full" rows="4">{{$sign->description}}</textarea>
                                </div>
                            </div>
