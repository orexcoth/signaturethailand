        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">ชื่อ th</th>
                    <th class="whitespace-nowrap">ชื่อ en</th>
            ...
            @if($query->count() > 0)
                @foreach($query as $keyres => $res)
                    <tr class="intro-x">
                        ...
                        <td><div class="text-slate-500 text-sm whitespace-nowrap mt-0.5">{{$res->names_id}}</div></td>
                        <td><div class="text-slate-500 text-sm whitespace-nowrap mt-0.5">{{$res->lang}}</div></td>
                        <td><div class="text-slate-500 text-sm whitespace-nowrap mt-0.5">{{$res->name->name_th}}</div></td>
                        <td><div class="text-slate-500 text-sm whitespace-nowrap mt-0.5">{{$res->name->name_en}}</div></td>
